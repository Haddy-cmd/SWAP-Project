...
class DocumentController extends Controller
{
    ...
    {
        $request->validate([
            'document_type' => ['required', 'string', 'in:birth_certificate,grades,income_certificate,id_photo,recommendation_letter,other'],
        ...
        $path = $file->store("documents/{$applicationId}", 's3');
