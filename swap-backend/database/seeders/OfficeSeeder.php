...
class OfficeSeeder extends Seeder
{
    public function run(): void
    {
        $offices = [
            ...
            ['name' => 'Finance and Accounting Office', 'description' => 'Manages university finances, budgets, and student financial transactions.', 'head_name' => 'Mrs. Bai Macarandag', 'location' => 'Administration Building, 1st Floor', 'max_recipients' => 5],
        ];
